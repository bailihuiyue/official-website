module.exports = {
  ...
  "post /Cases/CreateCases": () => true,
  "post /Cases/ModifiedCases": () => true,
  "post /Cases/DeleteCases": () => true,
  //
  "/Course/GetCourseAll": [
  ...
  "post /Course/CreateCourse": () => true,
  "post /Course/ModifiedCourse": () => true,
  "post /Course/DeleteCourse": () => true,
  //
  "/Enterprise/GetEnterpriseAll": [],
  "post /Enterprise/CreateEnterprise": () => true,
  "post /Enterprise/ModifiedEnterprise": () => true,
  "post /Enterprise/DeleteEnterprise": () => true,
  //
  ...
  "post /DataDictionary/CreateDataDictionary": () => true,
  "post /DataDictionary/ModifiedDataDictionary": () => true,
  "post /DataDictionary/DeleteDataDictionary": () => true,
  //
  "/Honor/GetHonorAll": [
    {
      Id: 36,
  ...
  "post /Honor/CreateHonor": () => true,
  "post /Honor/ModifiedHonor": () => true,
  "post /Honor/DeleteHonor": () => true,
  //
  "/News": [
    {
      Id: 19,
  ...
  "post /News/CreateNews": () => true,
  "post /News/ModifiedNews": () => true,
  "post /News/DeleteNews": () => true,
  //
  "/Team/GetTeamAll": [
    {
      Id: 16,
  ...
  "post /Team/CreateTeam": () => true,
  "post /Team/ModifiedTeam": () => true,
  "post /Team/DeleteTeam": () => true,
};
